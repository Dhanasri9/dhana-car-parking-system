...
<head>
    ...
    <title>Manage Outgoing Car</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="manage-outgoingvehicle.php">Manage Car</a></li>
                                    <li class="active">Manage Outgoing Car</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Manage Outgoing Car</strong>
                        </div>
                        <div class="card-body">
                             <table class="table">
                <thead>
