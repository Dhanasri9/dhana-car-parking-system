...
<head>
    ...
    <title>Manage Incoming Car</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="manage-incomingvehicle.php">Manage Car</a></li>
                                    <li class="active">Manage Incoming Car</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Manage Incoming Car</strong>
                        </div>
                        <div class="card-body">
                             <table class="table">
                <thead>
