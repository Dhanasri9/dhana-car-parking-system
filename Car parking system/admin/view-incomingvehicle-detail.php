                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="manage-incomingvehicle.php">View Car</a></li>
                                    <li class="active">Incoming Car</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">View Incoming Car</strong>
                        </div>
                        <div class="card-body">
...
<tr>
   ...
   <select name="status" class="form-control" required="true" >
     <option value="Out">Outgoing Car</option>
   </select></td>
  </tr>
