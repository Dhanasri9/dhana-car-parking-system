...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  tblvehicle(ParkingNumber,VehicleCompanyname,RegistrationNumber,OwnerName,OwnerContactNumber) value('$parkingnumber','$vehcomp','$vehreno','$ownername','$ownercontno')");
    if ($query) {
                            ...
                            <div class="card-body card-block">
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Car Company</label></div>
